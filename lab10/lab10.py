...
def subseqs(s):
    ...
    if len(s) == 0:
        ...
        l1 = subseqs(s[1::]) 
        return l1 + insert_into_all(s[0],l1)
...
def non_decrease_subseqs(s):
    ...
    #         # b = ______________________
    #         return insert_into_all(s[0], a) + a
    # return subseq_helper(s, -2**31)
...
def reverse_other(t):
    ...
    # def helper(t, d):
    #     if d % 2 != 0:
    #         lst = [i.label for i in t.branches][::-1]
    #         for i in t.branches:
    #             i.label = lst[t.branches.index(i)]
    #             helper(i, d+1)
    #     else:
    #         for i in t.branches:
    #             helper(i, d+1)
